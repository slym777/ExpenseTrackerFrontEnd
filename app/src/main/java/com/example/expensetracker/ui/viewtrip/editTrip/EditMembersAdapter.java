...
import com.example.expensetracker.databinding.ViewEditMembersBinding;
...
public class EditMembersAdapter extends RecyclerView.Adapter<EditMembersAdapter.UserViewHolder> {
    private List<User> mUsers;

    public EditMembersAdapter(List<User> mUsers) {
        this.mUsers = mUsers;
    }
    ...
    public UserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ViewEditMembersBinding binding = ViewEditMembersBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
    ...
    public class UserViewHolder extends RecyclerView.ViewHolder {
        public ViewEditMembersBinding binding;

        public UserViewHolder(ViewEditMembersBinding binding) {
